...
class EmissorCarimboService
{
    ...
    public static function createRequestfile ($hash)
    {
        ...
        $cmd = "openssl ts -query -digest ".escapeshellarg($hash)." -sha256 -cert -out ".escapeshellarg($outfilepath);
     ...
     * @return <type>
     */
    public static function validate ($hash, $base64_response_string, $response_time, $tsa_cert_file) //validate()
    {
        if (strlen($hash) !== 40)
            throw new Exception("Invalid Hash");
